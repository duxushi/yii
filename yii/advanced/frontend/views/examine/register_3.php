...
<div class="main">
    <div class="check_label">
        ...
        <p class="handler-button">
            <a class="a_button" href="index.php?r=examine/register_2">上一步</a>
            <a class="a_button" href="index.php?r=examine/zo&hobby=1&id=<?=$_GET['id']?>">完成</a>
            <!-- <input type="submit" class="a_button" value="完成"> -->
        </p>
    </div>
</div>
